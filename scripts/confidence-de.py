...
query = "Erklären Sie, warum Wasser bei einer niedrigeren Temperatur kocht, wenn es bei derselben Höhe intensiver erhitzt wird?"

# More comprehensive set of stop words

#deutsche Stoppwörter (German stop words)

stop_words = {
    "der", "die", "das", "den", "dem", "des", "und", "ein", "eine", "einem", 
    "einer", "eines", "ist", "sind", "war", "waren", "in", "zu", "von", "mit", 
    "auf", "für", "an", "bei", "nach", "aus", "über", "unter", "durch", "um", 
    "als", "wie", "wenn", "dass", "aber", "oder", "sondern", "doch", "jedoch", 
    "so", "dann", "noch", "nur", "auch", "sehr", "mehr", "kann", "könnte", 
    "wird", "werden", "wurde", "wurden", "hat", "haben", "hatte", "hatten", 
    "bin", "bist", "sein", "seine", "ihr", "ihre", "sich", "nicht", "kein", 
    "keine", "hier", "dort", "da", "wo", "was", "wer", "wie", "warum", "wann", 
    "alle", "alles", "viele", "wenige", "einige", "manche", "jede", "jeder", 
    "jedes", "diese", "dieser", "dieses", "jene", "andere", "ein", "zwei", 
    "drei", "erste", "zweite", "dritte", "wieder", "weiter", "einmal", "schon", 
    "immer", "oft", "mal", "ganz", "gar", "etwa", "etwas", "nichts", "alles", 
    "mir", "dir", "ihm", "uns", "euch", "ihnen", "mich", "dich", "ihn", "sie", 
    "es", "wir", "ihr", "man", "bis", "seit", "während", "wegen", "trotz", 
    "ohne", "gegen", "zwischen", "hinter", "vor", "neben", "entlang", ",", "."
}
punctuation = {".", "!", "?", ",",":","-","_","(",")","[","]","{","}","'","\"","*","+","=","/","\\","|","@","#","$","%","^","&","~","`","<",">"}
